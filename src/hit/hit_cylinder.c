...
/*   Updated: 2022/11/03 18:14:39 by bsomers       ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
int	intersect_circle(t_cyl *cyl, t_ray ray, float t)
{
	float	radius;
	t_point	p;
	t_point	v;
	...
	// p = ray_at(ray, t);
	v = substract_points(p, cyl->center);
	d = dot_points(v, v);
